...
const PrivacyPolicyPage: React.FC = () => {
  ...
  const sections = [
    {
      ...
      content: (
        <>
          <p className="mb-3">
            Welcome to{" "}
            <span className="font-semibold text-primary">AuroFX</span> ("we",
      ...
      content: (
        <>
          <p className="mb-3">
            ...
            <span className="font-semibold">AuroFX</span>.
          </p>
          <p>
            Contact our Data Protection Officer at:{" "}
            <a
              href="mailto:dpo@aurofx.com"
  ...
  return (
    <>
      <Head>
        <title>AuroFX Privacy Policy | Data Protection</title>
        <meta
          name="description"
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <p className="text-gray-400">
              © {new Date().getFullYear()} AuroFX. All rights reserved.
            </p>
