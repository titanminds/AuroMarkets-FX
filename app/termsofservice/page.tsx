...
const TermsAndConditionsPage: React.FC = () => {
  ...
  const sections = [
    {
      ...
      content: (
        <>
          <p className="mb-3">
            By accessing and using the AuroFX platform ("Platform"), you agree to be bound by these Terms and Conditions ("Terms"). These Terms constitute a legally binding agreement between you and AuroFX Ltd.
          </p>
      ...
      content: (
        <>
          <p className="mb-3 text-gray-600">
            To the maximum extent permitted by applicable law, AuroFX Ltd. shall not be liable for:
          </p>
      ...
      content: (
        <div className="space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <h5 className="font-semibold text-gray-800 mb-2">By AuroFX</h5>
              <p className="text-sm text-gray-600">
  ...
  return (
    <>
      <Head>
        <title>AuroFX Terms & Conditions | Legal Agreement</title>
        <meta
          name="description"
          content="Review AuroFX Terms & Conditions. Understand our legal agreement covering trading rules, risk disclosure, and user responsibilities."
        />
      </Head>
          ...
          >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
              <div className="text-center max-w-3xl mx-auto">
                ...
                >
                  Our legal agreement governing your use of AuroFX trading platform
                </motion.p>
                <motion.div
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <div className="mt-2 text-red-700">
                      <p>
                        By using AuroFX, you acknowledge that you have read, understood, and agree to be bound by these Terms & Conditions. These terms contain important information regarding your rights, obligations, and risk disclosures.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <p className="text-gray-400">
              © {new Date().getFullYear()} AuroFX Ltd. All rights reserved.
            </p>
