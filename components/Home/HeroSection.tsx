    ...
    <section className="relative sm:min-h-screen w-full overflow-hidden bg-mate flex flex-col">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-b from-mate/80 via-mate/50 to-mate" />
      ...
      <div className="relative z-10 grow flex flex-col items-center justify-center px-4 text-center pt-40">
        <motion.div
          ...
          <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed mb-12">
            Access deep liquidity, ultra-low latency, and advanced ECN
            technology. The professional choice for modern algorithmic traders.
          </p>
